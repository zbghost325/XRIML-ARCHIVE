...
Mixed reality headsets with video or optical passthrough for blending real and virtual environments. Items marked with :material-cart-outline: can be checked out via [WebCheckout](https://zbghost325.github.io/XRIML-WIKI/policies/equipment-checkout/).
