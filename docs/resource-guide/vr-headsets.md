...
<div class="page-meta">
  <span class="meta-date">Last Updated: 03-30-2026 &middot; v4.0</span>
  <span class="tag">Equipment</span>
  <span class="tag">VR</span>
  <span class="tag tag-keralia">Keralia Training</span>
</div>

Virtual reality headsets available in the XRIML. Items marked with :material-cart-outline: can be checked out via [WebCheckout](https://zbghost325.github.io/XRIML-WIKI/policies/equipment-checkout/).
...
![Meta Quest 2](../images/equipment/meta-quest-2.jpg){ width="300", loading=lazy }
...
![HTC Vive Flow](../images/equipment/htc-vive-flow.jpg){ width="300", loading=lazy }
...
![HTC Vive Focus 3](../images/equipment/htc-vive-focus-3.jpg){ width="300", loading=lazy }
...
![HTC Vive Cosmos](../images/equipment/htc-vive-cosmos.jpg){ width="300", loading=lazy }
...
![HTC Vive Pro](../images/equipment/htc-vive-pro.jpg){ width="300", loading=lazy }
...
![HTC Vive Pro 2](../images/equipment/htc-vive-pro-2.jpg){ width="300", loading=lazy }
...
![HTC Vive Pro Eye](../images/equipment/htc-vive-pro-eye.jpg){ width="300", loading=lazy }
...
![Valve Index](../images/equipment/valve-index.jpg){ width="300", loading=lazy }
...
![Meta Oculus Rift](../images/equipment/oculus-rift-cv1.png){ width="300", loading=lazy }
...
![Oculus Rift S](../images/equipment/oculus-rift-s.jpg){ width="300", loading=lazy }
